//Blue alliance, starting near the storage unit, line up on the penultimate tile, spin the carousel and park in the storage unit. 
...
@Autonomous(group="Autonomous_v1", name="AutoB_su_16pts")
public class AutoB_su_16pts extends OpMode{
    ...
    public void loop() {
        ...
        num = 6;
        while (num == 6 && runtime.seconds()>5.00 && runtime.seconds()<6.90){
            car.setDirection(DcMotorSimple.Direction.FORWARD);
            car.setPower(-0.9);
        }
        ...
        num = 7;
        while (num == 7 && runtime.seconds()>7.10 && runtime.seconds()<9.00){
            car.setDirection(DcMotorSimple.Direction.FORWARD);
            car.setPower(-0.9);
        }   
        ...
        num = 8;
        while (num == 8 && runtime.seconds()>9.00 && runtime.seconds()<9.60){
            fl.setPower(-0.5);
            fr.setPower(-0.5);
            bl.setPower(-0.5);
            br.setPower(-0.5);
        ...
        num = 9;
        while (num== 9 && runtime.seconds()>9.60 && runtime.seconds()<10.50){
            fl.setPower(0.5);
            fr.setPower(-0.5);
            bl.setPower(-0.5);
            br.setPower(0.5);
        ...
        num = 10;
        while (num== 10 && runtime.seconds()>10.50 && runtime.seconds()<11.10){
            fl.setPower(-0.5);
            fr.setPower(-0.5);
            bl.setPower(-0.5);
            br.setPower(-0.5);
