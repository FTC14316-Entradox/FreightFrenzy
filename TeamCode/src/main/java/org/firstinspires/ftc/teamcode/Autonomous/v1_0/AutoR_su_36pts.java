//still work in progress - copied from AutoB_...36pts. When that file is complete, copy the necessary code in
//Red alliance, start near the storage unit, line up on the penultimate tile, spin the carousel, scan the barcode and park in storage unit. 
...
@Autonomous(group="Autonomous_v1", name="AutoR_su_36pts")
public class AutoR_su_36pts extends OpMode{
    ...
    public void loop() {
        ...
        while(num == 3 && ((DistanceSensor) colorSensor2).getDistance(DistanceUnit.CM)>1.00){
            fl.setPower(-0.2);
            fr.setPower(-0.2);
            bl.setPower(-0.2);
            br.setPower(-0.2);
        ...
        num = 4;
        telemetry.addLine("outofwhileloop");
        fl.setPower(0.0);
        fr.setPower(0.0);
        bl.setPower(0.0);
        br.setPower(0.0);
        
        while (num== 4 && runtime.seconds()>2.00 && runtime.seconds()<2.40){
            fl.setPower(-0.4);
            fr.setPower(0.4);
            bl.setPower(0.4);
            br.setPower(-0.4);
        ...
        num = 5;
        while (num == 5 && runtime.seconds()>2.40 && runtime.seconds()<5.00){
        ...
        num = 6;
        while (num == 6 && runtime.seconds()>5.00 && runtime.seconds()<6.80){
            car.setDirection(DcMotorSimple.Direction.FORWARD);
            car.setPower(-0.9);
        }
        ...
        num = 7;
        while (num == 7 && runtime.seconds()>7.10 && runtime.seconds()<8.40){
            car.setDirection(DcMotorSimple.Direction.FORWARD);
            car.setPower(-0.8);
        }   
        ...
        num = 8;
        while (num == 8 && runtime.seconds()>8.40 && runtime.seconds()<9.00){
            fl.setPower(-0.5);
            fr.setPower(-0.5);
            bl.setPower(-0.5);
            br.setPower(-0.5);
        ...
        num = 9;
        while (num == 9 && runtime.seconds()>9.10 && runtime.seconds()<9.50){
            fl.setPower(0.5);
            fr.setPower(0.5);
            bl.setPower(0.5);
            br.setPower(0.5);
        ...
        num = 10;
        while (num == 10 && runtime.seconds()>9.50 && runtime.seconds()<9.90){
            fl.setPower(0.6);
            fr.setPower(-0.6);
            bl.setPower(0.6);
            br.setPower(-0.6);
        ...
        num = 11;
        while (num == 11 && runtime.seconds()>10.00 && runtime.seconds()<11.20){
            fl.setPower(0.4);
            fr.setPower(-0.4);
            bl.setPower(-0.4);
            br.setPower(0.4);
        ...
        num=12;
        while (num == 12 && runtime.seconds()>11.20 && runtime.seconds()<11.40){
            fl.setPower(0.4);
            fr.setPower(0.4);
            bl.setPower(0.4);
            br.setPower(0.4);
        ...
        num=13;
        while (num == 13 && runtime.seconds()>11.45 && runtime.seconds()<11.90){
            fl.setPower(-0.4);
            fr.setPower(0.4);
            bl.setPower(0.4);
            br.setPower(-0.4);
                ...
                bl.setPower(0.0);
                br.setPower(0.0);
        while (num==14 && runtime.seconds() > 11.90 && runtime.seconds() <30.00){
        if (num==14 && runtime.seconds() > 11.90 && runtime.seconds() <30.00){
            int encoderbarcode1 = fl.getCurrentPosition();
            while (num==14&&((DistanceSensor) colorSensor1).getDistance(DistanceUnit.CM)>10.00){
                fl.setPower(-0.2);
                fr.setPower(0.2);
                bl.setPower(0.2);
                br.setPower(-0.2); 
            ...
            bl.setPower(0.0);
            br.setPower(0.0);
                int encoderbarcode2 = fl.getCurrentPosition()-encoderbarcode1;
                telemetry.addLine(Integer.toString(encoderbarcode2));
                telemetrydelay = encoderbarcode2;
                telemetry.update();
                num=15;
        } 
        }
        telemetry.addLine(Integer.toString(telemetrydelay));
        telemetry.update();
        num=15;
