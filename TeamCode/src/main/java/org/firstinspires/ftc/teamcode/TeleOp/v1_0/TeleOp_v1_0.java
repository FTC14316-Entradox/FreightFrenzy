...
@TeleOp(group="TeleOp_v1", name="TeleOp_v1_0")
public class TeleOp_v1_0 extends OpMode {
    ...
    public void loop() {
        ...
        double x = gamepad1.left_stick_x; // Choose drivers' preference to counteract imperfections
