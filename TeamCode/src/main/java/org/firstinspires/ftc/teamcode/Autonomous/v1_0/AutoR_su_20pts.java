//Red alliance, starting near the storage unit, lining up to the penultimate tile, spin the carousel, park in the ware house. 
...
public class AutoR_su_20pts extends OpMode{
    ...
    public void loop() {
        ...
        while (num == 4 && runtime.seconds()>6.00 && runtime.seconds()<7.90){
            car.setDirection(DcMotorSimple.Direction.FORWARD);
            car.setPower(-0.3);
        }
        ...
        while (num == 5 && runtime.seconds()>8.00 && runtime.seconds()<8.60){
            fl.setPower(-0.4);
            fr.setPower(-0.4);
            bl.setPower(-0.4);
            br.setPower(-0.4);
        ...
        while (num == 6 && runtime.seconds()>8.70 && runtime.seconds()<9.30){
            fl.setPower(0.5);
            fr.setPower(0.5);
            bl.setPower(0.5);
            br.setPower(0.5);
        ...
        while (num == 7 && runtime.seconds()>9.30 && runtime.seconds()<10.20){
            fl.setPower(-0.4);
            fr.setPower(0.4);
            bl.setPower(0.4);
            br.setPower(-0.4);
        ...
        while (num == 8 && runtime.seconds()>10.30 && runtime.seconds()<10.70){
            fl.setPower(0.6);
            fr.setPower(-0.6);
            bl.setPower(0.6);
            br.setPower(-0.6);
        ...
        while (num == 9 && runtime.seconds()>11.00 && runtime.seconds()<14.00){
            fl.setPower(0.9);
            fr.setPower(0.9);
            bl.setPower(0.9);
            br.setPower(0.9);
