//Red alliance, starting near the warehouse, park in the warehouse completely
...
@Autonomous(group="Autonomous_v1", name="AutoR_wh_10pts")
public class AutoR_wh_10pts extends OpMode{
    ...
    public void loop() {
        ...
        while(num == 2 && runtime.seconds()<3.00){
            fl.setPower(0.6);
            fr.setPower(0.6);
            bl.setPower(0.6);
            br.setPower(0.6);
