//Blue alliance, starting near the storage unit, line up at the penultimate tile, spin the carousel and park in the warehouse
...
@Autonomous(group="Autonomous_v1", name="AutoB_su_20pts")
public class AutoB_su_20pts extends OpMode{
    ...
    public void loop() {
        ...
        num = 9;
        while (num== 9 && runtime.seconds()>9.00 && runtime.seconds()<9.75){
            fl.setPower(0.5);
            fr.setPower(-0.5);
            bl.setPower(-0.5);
            br.setPower(0.5);
        ...
        num=10;
        while (num == 10 && runtime.seconds()>10.00 && runtime.seconds()<10.50){
            fl.setPower(-0.5);
            fr.setPower(-0.5);
            bl.setPower(-0.5);
            br.setPower(-0.5);
        ...
        num=11;
        while (num == 11 && runtime.seconds()>10.50 && runtime.seconds()<12.00){
            fl.setPower(0.9);
            fr.setPower(0.9);
            bl.setPower(0.9);
            br.setPower(0.9);
