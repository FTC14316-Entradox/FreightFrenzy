...
@Autonomous(group="Autonomous_v2.2", name="AutoR_car_v2_2")
public class AutoR_car_v2_2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (!isStopRequested()) {
            ...
            while (runtime.milliseconds() < 30000 && runtime.milliseconds() > 29500) {
                robot.drive(-0.3, 1);
            }
            robot.stop();
