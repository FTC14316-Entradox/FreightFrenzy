...
//Blue alliance, start near the storage unit, line up on the penultimate tile, spin the carousel, scan the barcode and park in storage unit. 
...
@Autonomous(group="Autonomous_v1", name="AutoB_su_36pts")
@Disabled
public class AutoB_su_36pts extends OpMode{
